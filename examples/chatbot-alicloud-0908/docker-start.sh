...
echo "============================================"
echo "🐳 Docker 模式启动 Chatbot Alicloud"
echo "============================================"
echo ""
...
# 检查 ALIBABA_CLOUD_API_KEY
if [ -z "${ALIBABA_CLOUD_API_KEY:-}" ]; then
    read -rsp "请输入 ALIBABA_CLOUD_API_KEY: " ALIBABA_CLOUD_API_KEY
    echo ""
fi

if [ -z "${ALIBABA_CLOUD_API_KEY}" ]; then
    echo "❌ 错误: ALIBABA_CLOUD_API_KEY 不能为空"
    exit 1
fi

echo "✅ API Key 已设置（长度: ${#ALIBABA_CLOUD_API_KEY}）"
echo ""
