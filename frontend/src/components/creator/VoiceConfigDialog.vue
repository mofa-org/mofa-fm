...
const availableVoices = [
  { id: 'alloy', name: 'Alloy', description: '通用、中性' },
  { id: 'echo', name: 'Echo', description: '温暖、圆润' },
  { id: 'fable', name: 'Fable', description: '英式、叙事' },
  { id: 'onyx', name: 'Onyx', description: '深沉、权威' },
  { id: 'nova', name: 'Nova', description: '活力、年轻' },
  { id: 'shimmer', name: 'Shimmer', description: '清晰、明亮' }
]
