    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_creator', models.BooleanField(default=False, verbose_name='创作者')),
                ('is_verified', models.BooleanField(default=False, help_text='官方认证', verbose_name='认证标记')),
                ('shows_count', models.IntegerField(default=0, verbose_name='节目数')),
                ('total_plays', models.IntegerField(default=0, verbose_name='总播放量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='creator_verification', to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '创作者验证',
                'verbose_name_plural': '创作者验证',
